...
const ShoppingCart = () => {
    ...
    return(
        <>
        <div className="bg-orange-100 min-h-screen p-4 sm:p-8">
            {/* Title section */}
            <div className="mb-4">
                <h1
            ...
            <div className="mt-6 md:gap-6 flex-1 space-y-4">
                ...
                {/* Item in cart */}
                <div className="flex items-start justify-between p-4 bg-white rounded-lg shadow border border-gray-200">
                    ...
                    <div className="flex gap-4">
                        ...
                        {/* Item in cart: info */}
                        <div>
                            <p className="font-medium text-lg">Tuotteen nimi</p>
                            <p className="text-gray-600">Tuotteen hinta</p>
                            <p className="text-gray-600">Tuotteen määrä</p>
                        </div>
                    </div>
