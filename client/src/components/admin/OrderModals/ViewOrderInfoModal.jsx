/**
 *
 * @param {Object} order - The order object containing information related to it.
                ...
                {order.reservations.map((reservation) => (
                  <li key={reservation.id} className="p-2 border-b">
                    ...
                    <p>
                      ...
                      {reservation.table_customer_count} Customers
                    </p>
                    <p>
                      <span className="font-semibold">Grill: </span>
                      {reservation.grill_customer_count} Customers
                    </p>
                  </li>
                ))}
              </ul>
            ...
            {order.gift_cards?.length ? (
              <ul>
                {order.gift_cards.map((giftCard) => (
                  <li key={giftCard.id}>
                    <p>
                      <span className="font-semibold">Gift Card ID: </span>
                      {giftCard.id}
                    </p>
                    <p>
