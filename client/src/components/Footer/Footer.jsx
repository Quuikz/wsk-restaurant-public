    ...
    <>
      ...
      <footer className="px-4 divide-y bg-gray-800 text-gray-300 py-8">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <li>
                  <Link to="#">Viikon Lista</Link>
                </li>
                <li>
                  <Link to="#">Lahjakortit</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <li>
                  <Link to="#">Sijainti kartalla</Link>
                </li>
                <li>
                  <Link to="#">Aukioloajat</Link>
                </li>
                <li>
        ...
        <div className="py-6 text-sm text-center dark:text-gray-600">
          © 2025 RymaUno 1. All rights reserved. You better believe so.
        </div>
      </footer>
    </>
  );
