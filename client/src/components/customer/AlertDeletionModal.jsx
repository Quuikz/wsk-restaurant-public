...
const AlertDeletionModal = ({isOpen, onClose, message}) => {
  if (!isOpen) {
    return null;
  }
        ...
        <div className="bg-white rounded-2xl shadow-lg w-full max-w-md">
          ...
          <div className="relative bg-neutral-primary-soft border-3 border-black rounded-2xl shadow-sm p-4 md:p-6 text-center text-black">
            ...
            <button
              ...
              className="cursor-pointer w-full mt-5 text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-indigo-400 font-medium rounded-md text-sm px-4 py-2.5 shadow focus:outline-none"
            >
              {finnish ? 'Poista' : 'Delete!'}
            </button>
            <button
              onClick={onClose}
              className="cursor-pointer w-full mt-5 text-white bg-slate-500 hover:bg-slate-600 focus:ring-4 focus:ring-indigo-400 font-medium rounded-md text-sm px-4 py-2.5 shadow focus:outline-none"
            >
